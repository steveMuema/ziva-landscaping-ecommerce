...
const catalog: {
  ...
  subcategories: {
    ...
    {
      category: { name: "Landscaping", description: "Soil, mulch and hard landscaping", isAgriculture: false, imageUrl: "/product-images/landscaping/landscaping-red-soil-and-manure-coco-peat-block-ksh-2000.jpg" },
      subcategories: [
        {
          name: "Soil & Mulch",
