...
export default function Footer() {
  return (
    <footer className="bg-[var(--card-bg)] text-[var(--foreground)] min-h-[250px] pt-10 border-t-2 border-[var(--card-border)] relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-start mb-12">
          ...
          <p className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wider mb-3">Follow us</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
          {/* Our Stores */}
          <div>
            <h3 className="text-lg font-bold mb-2 text-[var(--foreground)]">Our Stores</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-lg font-bold mb-2 text-[var(--foreground)]">Legal</h3>
<ul className="space-y-2 text-sm text-[var(--foreground)]">
            <li>
                <Link href="#" className="hover:text-[var(--accent)] transition-colors">
                  Privacy Policy
          ...
          {/* Contact Us */}
          <div>
            <h3 className="text-lg font-bold mb-2 text-[var(--foreground)]">Contact Us</h3>
            <a className="text-sm text-[var(--foreground)] hover:text-[var(--accent)]" href="mailto:sales@zivalandscaping.co.ke">Email: sales@zivalandscaping.co.ke</a>
            <p className="text-sm text-[var(--foreground)]">Phone/Text/WhatsApp: +25457133726</p>
          </div>
        </div>

        {/* Separator Line */}
        <div className="border-t border-[var(--card-border)] my-8" />
