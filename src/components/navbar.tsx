        ...
        <nav aria-label="Main" className="mx-auto max-w-full px-1 sm:px-2 lg:px-1">
          <div className="border-b border-[var(--header-border)]">
            <div className="flex h-20 items-center">
              {/* Burger menu: phone only (hidden from md up) */}
              <button
                type="button"
                onClick={() => setIsSidebarOpen(true)}
                className="relative rounded-md bg-transparent p-2 text-[var(--muted)] hover:text-[var(--foreground)] md:hidden"
              >
                <span className="absolute -inset-0.5" />
              ...
              <div className="md:hidden sm:flex md:ml-0">
                <Link href="/">
                  <span className="sr-only">Ziva Landscaping CO.</span>
                  <Image
...
<ShoppingBagIcon
                    aria-hidden="true"
                    className="size-6 shrink-0 text-[var(--muted)] group-hover:text-[var(--foreground)]"
                  />
                    <span className="ml-2 text-sm font-medium text-[var(--header-fg)] group-hover:text-[var(--foreground)] font-[family-name:var(--font-quicksand)]">
                      {items.length}
                    </span>
