...
export default function NavigationBar() {
  ...
  `}
      ...
      <header className="relative bg-white">
        <div className="flex h-10 items-center space-x-6 justify-center bg-emerald-700 px-4 text-sm font-medium text-white sm:px-2 lg:px-8 font-[family-name:var(--font-quicksand)]">
          <a
