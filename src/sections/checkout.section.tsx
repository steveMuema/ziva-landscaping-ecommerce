    ...
    try {
      if (paymentMethod === 'MPESA') {
        ...
        const stkRes = await fetch('/api/mpesa/stk-push', {
          ...
          body: JSON.stringify({
            orderId,
            phone: shippingData.phone.replace(/\D/g, '').slice(-9),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 font-[family-name:var(--font-quicksand)]">Payment (KSH)</h2>
              <p className="text-sm text-gray-600 mb-4 font-[family-name:var(--font-quicksand)]">
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    className="text-green-600"
                  />
                  <span className="font-[family-name:var(--font-quicksand)]">Pay in cash on delivery (recorded in Finance)</span>
                </label>
              </div>
            </div>
            ...
            <Suspense fallback={<div className="bg-gray-100 rounded-lg p-4 sm:p-6 text-gray-500">Loading order summary...</div>}>
              <div className="bg-gray-100 rounded-lg p-4 sm:p-6">
                ...
                <div className="border-t border-gray-200 pt-4 sm:pt-6 space-y-4">
                  <div className="flex justify-between text-gray-700 font-[family-name:var(--font-quicksand)]">
                    <span>Subtotal</span>
                    {loadingItems.size > 0 ? (
                  ...
                  <div className="flex justify-between text-base sm:text-lg font-semibold text-gray-900 font-[family-name:var(--font-quicksand)] pt-2 border-t">
                    <span>Total</span>
                    {loadingItems.size > 0 ? (
                      <div className="w-20 sm:w-24 h-5 sm:h-6 bg-gray-200 animate-pulse rounded-lg" />
                    ) : (
