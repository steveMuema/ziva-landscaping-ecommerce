...
export default function PromoSection() {
  return (
    <section className="w-full bg-[var(--background)]" aria-label="Collections by category">
            ...
            <div className="flex flex-col md:flex md:flex-row gap-6">
              ...
              >
                ...
                >
                  {/* Title Container (Top) */}
                  <div className="mb-4">
                    <h2 className="text-5xl md:text-3xl font-bold text-[var(--foreground)] font-[family-name:var(--font-quicksand)]">
                      {collection.alt}
                    </h2>
                  </div>
                  {/* Description and Button Container (Centered in Desktop) */}
                  <div className="flex flex-col justify-center flex-grow">
                    <p className="text-[var(--muted)] mb-6 font-[family-name:var(--font-quicksand)] font-medium">
                      {collection.description}
                    </p>
                    <div>
                      <Link
                        href={collection.category}
                        className="inline-block bg-[var(--accent)] text-white px-6 py-3 rounded-md hover:opacity-90 transition-colors duration-300"
                      >
                        Shop Now
                      </Link>
                    </div>
